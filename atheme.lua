...
theme.wallpaper = "~/Wallpapers/janedoe/jane-doe.jpg"
theme.bg_focus      = "#4b4b4b"
theme.bg_normal      = "#2d2d2d"
theme.bg_minimize   = "#25384d"
theme.bg_urgent     = "#ff0000"--constant
theme.bg_systray    = theme.bg_normal

theme.fg_focus     = "#d3d0c8"
theme.fg_normal      = "#d3d0c8"
theme.fg_minimize   = "#6d6f70"
theme.fg_urgent     = "#ffffff"--constant

theme.border_focus  = "#d3d0c8"
theme.border_normal = "#6e6e72"
...
theme.awesome_icon = "/home/ian/.config/awesome/arch.png"
